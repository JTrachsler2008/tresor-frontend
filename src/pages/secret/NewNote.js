        ...
        <div style={styles.page}>
            <div style={styles.card}>
                <div style={styles.cardHeader}>
                    ...
                    <div>
                        <h2 style={styles.title}>Neue Notiz</h2>
                        <p style={styles.subtitle}>Geheime Notizen sicher speichern</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div style={styles.field}>
                        ...
                        <input style={styles.input} type="text" value={values.title}
                               onChange={e => setValues(p => ({...p, title: e.target.value}))}
                               required placeholder="z.B. Wichtige Zugangsdaten" />
                    </div>
                    <div style={styles.field}>
                        <label style={styles.label}>Inhalt</label>
                        <textarea style={styles.textarea} value={values.content}
                                  onChange={e => setValues(p => ({...p, content: e.target.value}))}
                                  required placeholder="Notiz hier eingeben..." rows={6} />
                    </div>
...
const styles = {
    ...
    card: {background: '#fff', border: '1px solid #e8eaf0', borderTop: '3px solid #4aad4a', borderRadius: '16px', padding: '2rem', width: '100%', maxWidth: '480px', boxShadow: '0 4px 24px rgba(0,0,0,0.07)'},
    ...
    textarea: {width: '100%', padding: '0.65rem 0.9rem', borderRadius: '8px', border: '1.5px solid #dde1f0', fontSize: '0.95rem', background: '#f8f9ff', boxSizing: 'border-box', resize: 'vertical', fontFamily: 'inherit'},
    ...
    btnPrimary: {padding: '0.7rem 1.5rem', background: '#4aad4a', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '0.95rem', fontWeight: '700', cursor: 'pointer'},
